...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  late final GeneratedColumn<String> description = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _githubUsernameMeta =
      const VerificationMeta('githubUsername');
  @override
  late final GeneratedColumn<String> githubUsername = GeneratedColumn<String>(
      'github_username', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  @override
  List<GeneratedColumn> get $columns => [id, name, description, githubUsername];
  @override
    ...
    if (data.containsKey('github_username')) {
      context.handle(
          ...
          githubUsername.isAcceptableOrUnknown(
              data['github_username']!, _githubUsernameMeta));
    }
    return context;
  }
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      githubUsername: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}github_username']),
    );
  }
...
class User extends DataClass implements Insertable<User> {
  ...
  User copyWith(
      ...
      User(
        ...
        githubUsername:
            githubUsername.present ? githubUsername.value : this.githubUsername,
      );
  @override
  String toString() {
  ...
  @override
  int get hashCode => Object.hash(id, name, description, githubUsername);
  @override
